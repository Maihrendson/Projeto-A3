...
public class SistemaAcademico {
        ...
        do {
            ...
            switch (opcao) {
                case 1:
                    ...
                    break;
                case 2:
                    ProfessorService.cadastrarProfessor(sc, professores, cursos);
                    break;
                case 3:
    ...
    public void menuCertificado() {
        ...
        do {
            System.out.println("\n--- MENU CERTIFICADO ---");
            System.out.println("1. Emitir Certificado para Aluno");
            ...
            switch (opcao) {
                case 1:
                    CertificadoService.emitirCertificado(sc, alunos, notas);
                    break;
                case 2:
                    System.out.println("Voltando...");
                    break;
